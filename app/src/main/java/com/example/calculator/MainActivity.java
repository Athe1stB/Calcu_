...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button10 = (Button)findViewById(R.id.percentage);
        ...
        buttonDot = (Button) findViewById(R.id.b67);
        buttonC = (Button)findViewById(R.id.bC);
        buttonEqual = (Button)findViewById(R.id.be);
        crunchifyEditText = (EditText)findViewById(R.id.br);
